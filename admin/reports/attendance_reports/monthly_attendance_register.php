...
switch ($Clean['Process'])
{
    ...
    case 9:
        ...
        require_once('../../excel/monthly_attendance_register_for_all_classes_download_xls.php');
...
?>
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-1">
                                    ...
                                    <input type="hidden" name="hdnProcess" value="7" id="hdnProcess" />
                                    <button type="submit" class="btn btn-primary" id="SubmitSearch">Search</button>
                                </div>
                                <div class="col-lg-5">
                                    <button type="submit" class="btn btn-primary" onclick="$('#hdnProcess').val(9);" id="DownloadExcel">Download Monthly Attandance Register(All Classes)</button>
                                </div>
                            </div>
                        </div>
                    </div>
