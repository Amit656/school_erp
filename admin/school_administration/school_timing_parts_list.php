...
if ($LoggedUser->HasPermissionForTask(TASK_LIST_SCHOOL_TIMINGS_PARTS) !== true)
{
...
{
	case 5:
		if ($LoggedUser->HasPermissionForTask(TASK_DELETE_SCHOOL_TIMINGS_PARTS) !== true)
		{
			header('location:/admin/unauthorized_login_admin.php');
			exit;
		}
...
?>
<title>School Timing Parts List</title>
</head>
...
?>                    
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">School Timing Parts List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div>
                                <div class="row">
                                    <div class="col-lg-6">
                                    <div class="add-new-btn-container"><a href="add_school_timing_parts.php" class="btn btn-primary<?php echo $LoggedUser->HasPermissionForTask(TASK_ADD_SCHOOL_TIMINGS_PARTS) === true ? '' : ' disabled'; ?>" role="button">Add New Timing Part</a></div>
                                    </div>
                                    <div class="col-lg-6">
...
?>
                                <div class="row" id="RecordTableHeading">
                                    <div class="col-lg-12">
                                    	<div class="report-heading-container"><strong>Timimg Part Details on <?php echo date('d-m-Y h:i A'); ?></strong></div>
                                    </div>
								</div>
...
<?php
                                                    ...
                                                    {
                                                        echo '<a href="edit_school_timing_part.php?Process=2&amp;SchoolTimingPartID=' . $TimingPartID . '">Edit</a>';
                                                    }
                                                    else
                                                    {
                                                        echo 'Edit';
                                                    ...
                                                    if ($LoggedUser->HasPermissionForTask(TASK_DELETE_SCHOOL_TIMINGS_PARTS) === true)
                                                    {
                                                        echo '<a class="delete-record" href="school_timing_parts_list.php?Process=5&amp;SchoolTimingPartID=' . $TimingPartID . '">Delete</a>';
                                                    }
                                                    else
                                                    {
                                                        echo 'Delete';
