...
try
{
	...
	if (!array_key_exists($Clean['ClassID'], $AllClasses))
	{
	    $Response->SetError(1);
	...
	$AllClassSections = AddedClass::GetClassSections($Clean['ClassID']);
	...
	$Response->PushData('ClassSectionList', $ClassSectionList);
}
