...
try
{
	$BranchStaffObject = new BranchStaff(0, $Clean['UserName']);

	if ($BranchStaffObject->GetStaffCategory() != 'Management')
	{
		$Response->SetError(1);
		$Response->SetErrorCode(100025);
		$Response->SetMessage('Cannot log in, may be you are not a management staff.');
	...
	$AuthObject->AppLogin($UniqueToken, ROLE_SITE_MANAGEMENT_STAFF);
}
