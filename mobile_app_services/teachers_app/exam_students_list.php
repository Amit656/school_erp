...
try
{
	...
	foreach ($Obtainedmarks as $StudentID => $Details) 
	{
		$StudentObtainedmarks[$StudentID]['StudentID'] = $StudentID;
		$StudentObtainedmarks[$StudentID]['Obtainedmark'] = $Details['Marks'];
		$StudentObtainedmarks[$StudentID]['Status'] = $Details['Status'];
	}
