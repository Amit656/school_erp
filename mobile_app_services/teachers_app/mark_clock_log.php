...
$Clean['Latitude'] = '27.559529';
$Clean['Longitude'] = '80.682773'; 

// $Clean['Latitude'] = '26.910083';
// $Clean['Longitude'] = '80.953577'; // managineers
...
// 	if ( !getDistance( $Clean['Latitude'], $Clean['Longitude'], $Clean['UserLatitude'], $Clean['UserLongitude'], .500))
// 	{
// 		$Response->SetError(1);
