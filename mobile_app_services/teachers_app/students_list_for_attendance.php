...
$Clean['SchoolCode'] = '';
$Clean['UniqueToken'] = 'd722cdad09edc9114bf05e22aa6d3944';

//	Other Variables
$Clean['ClassSectionID'] = 3;
...
try
{
	...
	$StudentsList = array();
	$StudentsList = ClassAttendence::GetClassAttendence($Clean['ClassSectionID'], date('Y-m-d'));
